            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between">
                        ...
                        <a href="{{ route('patients.create') }}" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">Patient store</a>
                    </div>
                    <div class="mt-4">
                                ...
                                @forelse ($patients as $patient)
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2" style="width: 260px">
                                            <a href="{{ route('patients.show', $patient) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">{{ __('Ver') }}</a>
                                            <a href="{{ route('patients.edit', $patient) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">{{ __('Editar') }}</a>
